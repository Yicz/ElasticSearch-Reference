...
The `function_score` query provides several types of score functions.
  ...
  * [`script_score`](query-dsl-function-score-query.html#function-script-score "Script score")
  * [`weight`](query-dsl-function-score-query.html#function-weight "Weight")
  * [`random_score`](query-dsl-function-score-query.html#function-random "Random")
  * [`field_value_factor`](query-dsl-function-score-query.html#function-field-value-factor "Field Value factor")
  * [decay functions](query-dsl-function-score-query.html#function-decay "Decay functions"): `gauss`, `linear`, `exp`
...
In the above example, the field is a [`geo_point`](geo-point.html "Geo-point datatype") and origin can be provided in geo format. `scale` and `offset` must be given with a unit in this case. If your field is a date field, you can set `scale` and `offset` as days, weeks, and so on. Example:
...
The date format of the origin depends on the [`format`](mapping-date-format.html "format") defined in your mapping. If you do not define the origin, the current time is used.   
...
See [Normal decay, keyword `gauss`](query-dsl-function-score-query.html#gauss-decay "Normal decay, keyword gauss") for graphs demonstrating the curve generated by the `gauss` function.
...
See [Exponential decay, keyword `exp`](query-dsl-function-score-query.html#exp-decay "Exponential decay, keyword exp") for graphs demonstrating the curve generated by the `exp` function.
