    ...
    POST /_search
    {
        "aggs": {
            "my_date_histo":{
                ...
                "aggs":{
                    "the_sum":{
                        "sum":{ "field": "lemmings" } ![](images/icons/callouts/1.png)
                    },
                    "the_movavg":{
                        "moving_avg":{ "buckets_path": "the_sum" } ![](images/icons/callouts/2.png)
                    }
                }
            }
        }
    ...
    POST /_search
    {
        "aggs": {
            "my_date_histo": {
                ...
                "aggs": {
                    "the_movavg": {
                        "moving_avg": { "buckets_path": "_count" } ![](images/icons/callouts/1.png)
                    }
                }
            }
        }
        ...
        "histo": {
          ...
          "aggs": {
            ...
            "min_bucket_selector": {
              "bucket_selector": {
                "buckets_path": {
                  "count": "categories._bucket_count" ![](images/icons/callouts/1.png)
                },
                "script": {
